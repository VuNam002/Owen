import { HooksHome } from '../../../hooks/useHome'; // Adjust path as needed
...
const HomePage = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="max-w-md p-6 text-center">
          ...
          <h2 className="mb-2 text-xl font-semibold text-gray-800">Có lỗi xảy ra</h2>
  ...
  const ProductCard = ({ product }) => (
    <div className="overflow-hidden transition-shadow duration-300 bg-white rounded-lg shadow-md hover:shadow-lg">
      <div className="bg-gray-200 aspect-w-1 aspect-h-1">
        <img
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="px-4 py-8 mx-auto max-w-7xl">
        ...
        {productsFeatured.length > 0 && (
          <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-sm text-gray-500">{productsFeatured.length} sản phẩm</span>
            </div>
        ...
        {productsNew.length > 0 && (
          <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-sm text-gray-500">{productsNew.length} sản phẩm</span>
            </div>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        {categories.length > 0 && (
          <section className="mb-12">
            <h2 className="mb-8 text-2xl font-bold text-gray-900">Sản phẩm theo danh mục</h2>
        ...
        {articlesFeatured.length > 0 && (
          <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-sm text-gray-500">{articlesFeatured.length} bài viết</span>
            </div>
        ...
        {/* Empty State */}
        {productsFeatured.length === 0 && productsNew.length === 0 && categories.length === 0 && articlesFeatured.length === 0 && (
